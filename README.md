...
여러 이미지를 한 번에 **중심 기준으로 원하는 크기에 맞게 크롭**하는 도구입니다.

웹 버전과 macOS 네이티브 앱을 함께 제공합니다. 입력 이미지가 목표 크기보다 작으면 **cover 방식으로 확대한 뒤 중심을 기준으로 크롭**합니다.
...
3. 결과 파일명은 `원본이름_cropped.확장자` 형식입니다.
